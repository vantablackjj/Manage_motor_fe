...
export const API_BASE_URL = import.meta.env.REACT_APP_API_BASE_URL || 'https://motor-manage.onrender.com';
...
PHU_TUNG_LICH_SU: (ma_pt) => `/phu-tung/${ma_pt}/lich-su`,
  ...
  CHUYEN_KHO_TU_CHOI: (ma_phieu) => `/chuyen-kho/${ma_phieu}/tu-choi`,
