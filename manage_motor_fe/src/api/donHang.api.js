...
export const donHangAPI = {
  ...
  addChiTiet: async (ma_phieu, data) => {
    return axiosInstance.post(API_ENDPOINTS.DON_HANG_MUA_CHI_TIET(ma_phieu), data);
  },
  
  // Update chi tiet
  updateChiTiet: async (ma_phieu, stt, data) => {
    return axiosInstance.put(`${API_ENDPOINTS.DON_HANG_MUA_CHI_TIET(ma_phieu)}/${stt}`, data);
  },
  
  // Delete chi tiet
  deleteChiTiet: async (ma_phieu, stt) => {
    return axiosInstance.delete(`${API_ENDPOINTS.DON_HANG_MUA_CHI_TIET(ma_phieu)}/${stt}`);
  },
